 ...
 */
package tiposervicoprestado.dao;
 ...
 * @author boss
 */
public class TipoServicoPrestadoDaoImpl extends BaseDaoImpl<TipoServicoPrestadoBean> implements TipoServicoPrestadoDao {

    public TipoServicoPrestadoDaoImpl() {
        super(TipoServicoPrestadoBean.class);
    }
