 ...
 */
package pessoasrelacionadas.dao;
 ...
 * @author boss
 */
public class PessoasRelacionadasDaoImpl extends BaseDaoImpl<PessoasRelacionadasBean> implements PessoasRelacionadasDao {

    public PessoasRelacionadasDaoImpl() {
        super(PessoasRelacionadasBean.class);
    }
