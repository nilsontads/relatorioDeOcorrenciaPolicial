 ...
 * @author boss
 */
public class TipoOcorrenciaDaoImpl extends BaseDaoImpl<TipoOcorrenciaBean> implements TipoOcorrenciaDao {

    public TipoOcorrenciaDaoImpl() {
        super(TipoOcorrenciaBean.class);
    }
